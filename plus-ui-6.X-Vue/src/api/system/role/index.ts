...
export const listRole = (query: RoleQuery): TableDataPromise<RoleVO> => {
  return request({
 ...
 * 查询角色已授权用户列表
 */
export const allocatedUserList = (query: UserQuery): TableDataPromise<UserVO> => {
  return request({
 ...
 * 查询角色未授权用户列表
 */
export const unallocatedUserList = (query: UserQuery): TableDataPromise<UserVO> => {
  return request({
